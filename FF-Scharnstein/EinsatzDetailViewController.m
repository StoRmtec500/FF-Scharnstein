...
@synthesize lblEinsatzNummer, strEinsatzNummer, lblEinsatzSubTyp, strEinsatzSubTyp, lblEinsatzAdresse, strEinsatzAdresse, lblEinsatzAdresse2, strEinsartAdresse2, lblEinsatzEnde, strEinsartEnde, lblEinsatzStartzeit, strEinsatzStartzeit, lblEinsatzStatus, strEinsatzStatus, lblEinsatzAdresseEarea, strEinsatzAdresseEarea;
...
- (void)viewDidLoad
{
    ...
    lblEinsatzAdresseEarea.text = strEinsatzAdresseEarea;
    NSString *str1 = strEinsartEnde;
    NSString *newstr1 = [str1 substringWithRange:NSMakeRange(5, [str1 length]-11)];
...
- (void)viewDidUnload {
    ...
    [self setLblEinsatzAdresseEarea:nil];
    [super viewDidUnload];
}
@end
